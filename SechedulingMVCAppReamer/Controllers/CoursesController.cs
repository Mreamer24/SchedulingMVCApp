...
namespace SechedulingMVCAppReamer.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseID,CourseNumber,CourseName,DepartmentID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseID,CourseNumber,CourseName,DepartmentID")] Course course)
        {
